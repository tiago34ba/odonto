...
use App\Models\Saas\SaasBillingModulo;

class SaasBillingModuloController extends AbstractSaasCrudController
{
    protected function modelClass(): string
    {
        return SaasBillingModulo::class;
    }
    ...
    protected function validationRules(bool $isUpdate = false): array
    {
        ...
        return [
            'submodulo' => [$idRule, 'string', 'in:assinaturas,faturas,pagamentos,inadimplencia'],
