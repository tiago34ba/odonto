...
use App\Models\Saas\SaasBiModulo;

class SaasBiModuloController extends AbstractSaasCrudController
{
    protected function modelClass(): string
    {
        return SaasBiModulo::class;
    }
    ...
    protected function validationRules(bool $isUpdate = false): array
    {
        ...
        return [
            'submodulo' => [$idRule, 'string', 'in:kpis,saude_conta,cohort_retencao,forecast'],
