...
use App\Models\Saas\SaasSecurityModulo;

class SaasSecurityModuloController extends AbstractSaasCrudController
{
    protected function modelClass(): string
    {
        return SaasSecurityModulo::class;
    }
    ...
    protected function validationRules(bool $isUpdate = false): array
    {
        ...
        return [
            'submodulo' => [$idRule, 'string', 'in:rbac,auditoria,sessoes_tokens,politicas_seguranca'],
