...
use App\Models\Saas\SaasTenantModulo;

class SaasTenantModuloController extends AbstractSaasCrudController
{
    protected function modelClass(): string
    {
        return SaasTenantModulo::class;
    }
    ...
    protected function validationRules(bool $isUpdate = false): array
    {
        ...
        return [
            'submodulo' => [$idRule, 'string', 'in:provisionamento,ciclo_vida,limites_plano,dados_clinica'],
