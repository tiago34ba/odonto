...
class ApiSecurityMiddleware
{
    ...
    {
        // Responder preflight sem passar pelo restante do pipeline
        if ($request->isMethod('OPTIONS')) {
            $preflightResponse = response()->noContent();
            $this->setCorsHeaders($request, $preflightResponse);
    ...
    /**
     * Aplica cabeçalhos CORS de forma segura.
     */
    protected function setCorsHeaders(Request $request, Response $response): void
    {
    ...
    /**
     * Resolve a origem permitida baseada no header Origin.
     */
    protected function resolveAllowedOrigin(Request $request): string
    {
