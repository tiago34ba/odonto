...
// ...existing code...
// Todos os styled-components e estrutura seguem o padrão do ModalProcedimento
// ModalOverlay, ModalContainer, ModalHeader, ModalTitle, CloseButton, ModalBody, ModalFooter, Button, Input, Select, TextArea, ErrorMessage
// Campos organizados em seções, títulos e ícones padronizados
// Botões de ação e mensagens de erro padronizados
// ...existing code...
...
const AddFornecedorForm: React.FC<AddFornecedorFormProps> = ({ onClose, onSubmit }) => {
